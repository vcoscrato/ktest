...
#'
#' - pairwiseCommonArea: Groups pairwise common area triangular matrix (just if >= 3 groups).
#'
...
plot.kTest = function(output) {
  ...
  plot(output$densities[[1]], col = 1, main = "", xlab = xlabel, ylab = "", ylim = c(0, ymax))
